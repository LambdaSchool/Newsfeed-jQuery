...
function articleCreator() {
  const input = [$("#articleCreatorInputH2"), $("#articleCreatorInputDate"), $("#articleCreatorTextarea1")];
  ...
  input.map(element => element.val(""));
  // Clear input fields https://stackoverflow.com/a/6364347
}
